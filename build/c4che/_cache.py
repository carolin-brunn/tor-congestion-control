...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/carolin/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1618343417471/work=/usr/local/src/conda/python-3.8.8', '-fdebug-prefix-map=/home/carolin/anaconda3=/usr/local/src/conda-prefix', '-fno-semantic-interposition', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/carolin/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python_1618343417471/work=/usr/local/src/conda/python-3.8.8', '-fdebug-prefix-map=/home/carolin/anaconda3=/usr/local/src/conda-prefix', '-fno-semantic-interposition', '-fuse-linker-plugin', '-ffat-lto-objects', '-flto-partition=none', '-flto', '-fwrapv', '-O3']
...
EXAMPLE_DIRECTORIES = ['ipv6', 'udp-client-server', 'tutorial', 'stats', 'error-model', 'matrix-topology', 'wireless', 'realtime', 'socket', 'routing', 'naming', 'tcp', 'traffic-control', 'energy', 'udp']
...
INCLUDES_PYEMBED = ['/home/carolin/anaconda3/include/python3.8']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/home/carolin/anaconda3/lib/python3.8/config-3.8-x86_64-linux-gnu', '/home/carolin/anaconda3/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_PYEMBED = ['crypt', 'pthread', 'dl', 'util', 'rt', 'm', 'm', 'crypt', 'pthread', 'dl', 'util', 'rt', 'm', 'm']
LIB_RT = ['rt']
LIB_ST = '-l%s'
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/9', '/home/carolin/Schreibtisch/uni/masterProject/git/github/tor-congestion-control/build/lib']
...
cfg_files = ['/home/carolin/Schreibtisch/uni/masterProject/git/github/tor-congestion-control/build/ns3/config-store-config.h', '/home/carolin/Schreibtisch/uni/masterProject/git/github/tor-congestion-control/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
